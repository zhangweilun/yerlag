...
// GetGrayscaleDataHandler returns the Grayscale trust data handler.
func GetGrayscaleDataHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		svc := institutional.NewGrayscaleService(ctx)
		data, err := svc.GetGrayscaleData(r.Context())
		if err != nil {
